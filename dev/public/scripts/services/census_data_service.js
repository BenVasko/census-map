...
vm.getCountyPopAge = (targetState) => {
    return $http({
        ...
        ${dataHeaders.male67_69},${dataHeaders.male70_74},${dataHeaders.male75_79},${dataHeaders.male80_84},${dataHeaders.male21}
        ${dataHeaders.male85_over}, ${dataHeaders.femaleUnder5}, ${dataHeaders.female5_9},${dataHeaders.female10_14},${dataHeaders.female15_17},
        ${dataHeaders.female18_19},${dataHeaders.female20},${dataHeaders.female21},${dataHeaders.female22_24},${dataHeaders.female25_29},
        ${dataHeaders.female30_34},${dataHeaders.female35_39},${dataHeaders.female40_44},${dataHeaders.female45_49},${dataHeaders.female50_54}
        ${dataHeaders.female55_59},${dataHeaders.female60_61},${dataHeaders.female62_64},${dataHeaders.female65_66},${dataHeaders.female67_69}
        ${dataHeaders.female70_74},${dataHeaders.female75_79},${dataHeaders.female80_84},${dataHeaders.female85_over},NAME&for=state:${targetState}&key=${dataHeaders.key}`,
        method:'GET'
    }).then((response) => {
        console.log(response.data)
        return response.data
...
vm.getStatePopRace00 = () => {
    return $http({
        ...
        NAME&for=state:${state.all}&key=${dataHeaders.key}`,
        method:'GET'
    }).then((response) => {
        console.log(response.data);
        return response.data
...
vm.getCountyPopRace00 = (targetState) => {
    return $http({
        url:`https://api.census.gov/data/2000/sf1?get=${dataHeaders.white00},${dataHeaders.black00},${dataHeaders.americanIndian00},
        ${dataHeaders.asian00},${dataHeaders.other00},${dataHeaders.hawaiian00},${dataHeaders.multiple00}
        ,NAME&for=county:*&in=state:${targetState}&key=${dataHeaders.key}`,
        method:'GET'
    }).then((response) => {
        console.log(response.data)
        return response.data
...
vm.getStatePopAge00 = () => {
    return $http({
        ...
        ${dataHeaders.female70_74_00},${dataHeaders.female75_79_00},${dataHeaders.female80_84_00},${dataHeaders.female85_over_00},NAME&for=state:${state.all}&key=${dataHeaders.key}`,
        method:'GET'
    }).then((response) => {
        console.log(response.data);
        return response.data
...
vm.getCountyPopAge00 = (targetState) => {
    return $http({
        ...
        ${dataHeaders.female30_34_00},${dataHeaders.female35_39_00},${dataHeaders.female40_44_00},${dataHeaders.female45_49_00},${dataHeaders.female50_54_00}
        ${dataHeaders.female55_59},${dataHeaders.female60_61_00},${dataHeaders.female62_64_00},${dataHeaders.female65_66_00},${dataHeaders.female67_69_00}
        ${dataHeaders.female70_74_00},${dataHeaders.female75_79_00},${dataHeaders.female80_84_00},${dataHeaders.female85_over_00},NAME&for=state:${targetState}&key=${dataHeaders.key}`,
        method:'GET'
    }).then((response) => {
        console.log(response.data)
        return response.data
...
vm.getStatePopRace90 = () => {
    return $http({
        ...
        ANPSADPI&for=state:${state.all}&key=${dataHeaders.key}`,
        method:'GET'
    }).then((response) => {
        console.log(response.data);
        return response.data
...
vm.getCountyPopRace90 = (targetState) => {
    return $http({
        url:`https://api.census.gov/data/1990/sf1?get=${dataHeaders.white90},${dataHeaders.black90},${dataHeaders.americanIndian90},
        ${dataHeaders.asian90},${dataHeaders.other90},${dataHeaders.hawaiian90}
        ,ANPSADPI&for=county:*&in=state:${targetState}&key=${dataHeaders.key}`,
        method:'GET'
    }).then((response) => {
        console.log(response.data)
        return response.data
...
vm.getStatePopAge90 = () => {
    return $http({
        ...
        ${dataHeaders.a75_79_90},${dataHeaders.a80_84_90},${dataHeaders.a_over_85_90},ANPSADPI&for=state:${state.all}&key=${dataHeaders.key}`,
        method:'GET'
    }).then((response) => {
        console.log(response.data);
        return response.data
...
vm.getCountyPopAge90 = (targetState) => {
    return $http({
        ...
        ${dataHeaders.a30_34},${dataHeaders.a35_39_90},${dataHeaders.a40_44_90},${dataHeaders.a45_49_90},${dataHeaders.a50_54_90}
        ${dataHeaders.a55_59_90}, ${dataHeaders.a60_61_90}, ${dataHeaders.a62_64_90},${dataHeaders.a65_69_90},${dataHeaders.a70_74_90},
        ${dataHeaders.a75_79_90},${dataHeaders.a80_84_90},${dataHeaders.a_over_85_90},ANPSADPI&for=state:${targetState}&key=${dataHeaders.key}`,
        method:'GET'
    }).then((response) => {
        console.log(response.data)
        return response.data
